...
class Model:
    ...
    def train(self, atbats, pitches=None):
        ...
        :param atbats: a pandas data frame of atbats
        :param pitches: a pandas data frame of all associated pitches
        """
        pass

    def update(self, atbats=None, pitches=None):
        """
    ...
    def predict(self, atbats):
        ...
        :param atbats: a pandas data frame containing atbat data
...
class Baseline(Model):
    ...
    def train(self, atbats, pitches=None):
        totals = atbats.batter.value_counts()
        hits = atbats[atbats.hit].batter.value_counts()
...
class Ensemble(Model):
    ...
    def train(self, atbats, pitches):
        for model in self.submodels:
            model.train(atbats, pitches)
    
    def update(self, atbats, pitches):
        for model in self.submodels:
            model.update(atbats, pitches)
